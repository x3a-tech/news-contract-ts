...
/**
 * @generated from protobuf message news.FavoriteFolder
 */
export interface FavoriteFolder {
    ...
    title: string;
    /**
     * @generated from protobuf field: int32 icon = 3;
     */
    icon: number;
}
/**
 * @generated from protobuf message news.GetFavoritesParams
 */
export interface GetFavoritesParams {
    ...
    accountUuid: Uint8Array;
    /**
     * @generated from protobuf field: optional bytes folder_uuid = 2;
     */
    folderUuid?: Uint8Array;
}
/**
 * @generated from protobuf message news.GetFavoritesResponse
 */
export interface GetFavoritesResponse {
    /**
     * @generated from protobuf field: repeated news.FavoriteFolder favorites = 1;
     */
    favorites: FavoriteFolder[];
    /**
     * @generated from protobuf field: repeated news.ArticleShort articles = 2;
     */
    articles: ArticleShort[];
}
/**
 * @generated from protobuf message news.HasFavoritesParams
 */
export interface HasFavoritesParams {
    /**
     * @generated from protobuf field: bytes account_uuid = 1;
     */
    accountUuid: Uint8Array;
    /**
     * @generated from protobuf field: repeated bytes article_uuids = 2;
     */
    articleUuids: Uint8Array[];
}
/**
 * @generated from protobuf message news.HasFavoritesResponse
 */
export interface HasFavoritesResponse {
    /**
     * @generated from protobuf field: map<string, bool> favorites = 1;
     */
    favorites: {
        [key: string]: boolean;
    };
...
/**
 * @generated from protobuf message news.ToggleFavoriteParams
 */
export interface ToggleFavoriteParams {
    ...
    articleUuid: Uint8Array;
    /**
     * @generated from protobuf field: optional bytes folder_uuid = 3;
     */
    folderUuid?: Uint8Array;
}
/**
 * @generated from protobuf message news.MoveFavoriteParams
 */
export interface MoveFavoriteParams {
    /**
     * @generated from protobuf field: bytes account_uuid = 1;
     */
    accountUuid: Uint8Array;
...
/**
 * @generated from protobuf message news.CreateFavoriteFolderParams
 */
export interface CreateFavoriteFolderParams {
    /**
     * @generated from protobuf field: bytes account_uuid = 1;
     */
    accountUuid: Uint8Array;
...
/**
 * @generated from protobuf message news.UpdateFavoriteFolderParams
 */
export interface UpdateFavoriteFolderParams {
    /**
     * @generated from protobuf field: bytes uuid = 1;
     */
    uuid: Uint8Array;
...
// @generated message type with reflection information, may provide speed optimized methods
class FavoriteFolder$Type extends MessageType<FavoriteFolder> {
    constructor() {
        super("news.FavoriteFolder", [
            { no: 1, name: "uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "icon", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<FavoriteFolder>): FavoriteFolder {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.uuid = new Uint8Array(0);
        message.title = "";
        message.icon = 0;
        if (value !== undefined)
            reflectionMergePartial<FavoriteFolder>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: FavoriteFolder): FavoriteFolder {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: FavoriteFolder, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes uuid = 1; */
        if (message.uuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.uuid);
        /* string title = 2; */
...
/**
 * @generated MessageType for protobuf message news.FavoriteFolder
 */
export const FavoriteFolder = new FavoriteFolder$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetFavoritesParams$Type extends MessageType<GetFavoritesParams> {
    constructor() {
        super("news.GetFavoritesParams", [
            { no: 1, name: "account_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "folder_uuid", kind: "scalar", opt: true, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<GetFavoritesParams>): GetFavoritesParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountUuid = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<GetFavoritesParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetFavoritesParams): GetFavoritesParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bytes account_uuid */ 1:
                    message.accountUuid = reader.bytes();
                    break;
                case /* optional bytes folder_uuid */ 2:
                    message.folderUuid = reader.bytes();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: GetFavoritesParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes account_uuid = 1; */
        if (message.accountUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.accountUuid);
        /* optional bytes folder_uuid = 2; */
        if (message.folderUuid !== undefined)
            writer.tag(2, WireType.LengthDelimited).bytes(message.folderUuid);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message news.GetFavoritesParams
 */
export const GetFavoritesParams = new GetFavoritesParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetFavoritesResponse$Type extends MessageType<GetFavoritesResponse> {
    constructor() {
        super("news.GetFavoritesResponse", [
            { no: 1, name: "favorites", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FavoriteFolder },
            { no: 2, name: "articles", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ArticleShort }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetFavoritesResponse): GetFavoritesResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated news.FavoriteFolder favorites */ 1:
                    message.favorites.push(FavoriteFolder.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated news.ArticleShort articles */ 2:
                    message.articles.push(ArticleShort.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: GetFavoritesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated news.FavoriteFolder favorites = 1; */
        for (let i = 0; i < message.favorites.length; i++)
            FavoriteFolder.internalBinaryWrite(message.favorites[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* repeated news.ArticleShort articles = 2; */
        for (let i = 0; i < message.articles.length; i++)
            ArticleShort.internalBinaryWrite(message.articles[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message news.GetFavoritesResponse
 */
export const GetFavoritesResponse = new GetFavoritesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HasFavoritesParams$Type extends MessageType<HasFavoritesParams> {
    constructor() {
        super("news.HasFavoritesParams", [
            { no: 1, name: "account_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "article_uuids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<HasFavoritesParams>): HasFavoritesParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountUuid = new Uint8Array(0);
        message.articleUuids = [];
        if (value !== undefined)
            reflectionMergePartial<HasFavoritesParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HasFavoritesParams): HasFavoritesParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bytes account_uuid */ 1:
                    message.accountUuid = reader.bytes();
                    break;
                case /* repeated bytes article_uuids */ 2:
                    message.articleUuids.push(reader.bytes());
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: HasFavoritesParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes account_uuid = 1; */
        if (message.accountUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.accountUuid);
        /* repeated bytes article_uuids = 2; */
        for (let i = 0; i < message.articleUuids.length; i++)
            writer.tag(2, WireType.LengthDelimited).bytes(message.articleUuids[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message news.HasFavoritesParams
 */
export const HasFavoritesParams = new HasFavoritesParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HasFavoritesResponse$Type extends MessageType<HasFavoritesResponse> {
    constructor() {
        super("news.HasFavoritesResponse", [
            { no: 1, name: "favorites", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "scalar", T: 8 /*ScalarType.BOOL*/ } }
        ]);
    }
    create(value?: PartialMessage<HasFavoritesResponse>): HasFavoritesResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.favorites = {};
        if (value !== undefined)
            reflectionMergePartial<HasFavoritesResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: HasFavoritesResponse): HasFavoritesResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* map<string, bool> favorites */ 1:
                    this.binaryReadMap1(message.favorites, reader, options);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    private binaryReadMap1(map: HasFavoritesResponse["favorites"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof HasFavoritesResponse["favorites"] | undefined, val: HasFavoritesResponse["favorites"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.bool();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field news.HasFavoritesResponse.favorites");
            }
        }
        map[key ?? ""] = val ?? false;
    }
    internalBinaryWrite(message: HasFavoritesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* map<string, bool> favorites = 1; */
        for (let k of globalThis.Object.keys(message.favorites))
            writer.tag(1, WireType.LengthDelimited).fork().tag(1, WireType.LengthDelimited).string(k).tag(2, WireType.Varint).bool(message.favorites[k]).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message news.HasFavoritesResponse
 */
export const HasFavoritesResponse = new HasFavoritesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ToggleFavoriteParams$Type extends MessageType<ToggleFavoriteParams> {
    constructor() {
        super("news.ToggleFavoriteParams", [
            { no: 1, name: "account_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "article_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "folder_uuid", kind: "scalar", opt: true, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<ToggleFavoriteParams>): ToggleFavoriteParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountUuid = new Uint8Array(0);
        message.articleUuid = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<ToggleFavoriteParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ToggleFavoriteParams): ToggleFavoriteParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* bytes article_uuid */ 2:
                    message.articleUuid = reader.bytes();
                    break;
                case /* optional bytes folder_uuid */ 3:
                    message.folderUuid = reader.bytes();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ToggleFavoriteParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes account_uuid = 1; */
        if (message.accountUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.accountUuid);
        /* bytes article_uuid = 2; */
        if (message.articleUuid.length)
            writer.tag(2, WireType.LengthDelimited).bytes(message.articleUuid);
        /* optional bytes folder_uuid = 3; */
        if (message.folderUuid !== undefined)
            writer.tag(3, WireType.LengthDelimited).bytes(message.folderUuid);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message news.ToggleFavoriteParams
 */
export const ToggleFavoriteParams = new ToggleFavoriteParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MoveFavoriteParams$Type extends MessageType<MoveFavoriteParams> {
    constructor() {
        super("news.MoveFavoriteParams", [
            { no: 1, name: "account_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "article_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "folder_uuid", kind: "scalar", opt: true, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<MoveFavoriteParams>): MoveFavoriteParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountUuid = new Uint8Array(0);
        message.articleUuid = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<MoveFavoriteParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MoveFavoriteParams): MoveFavoriteParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: MoveFavoriteParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes account_uuid = 1; */
        if (message.accountUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.accountUuid);
        /* bytes article_uuid = 2; */
...
/**
 * @generated MessageType for protobuf message news.MoveFavoriteParams
 */
export const MoveFavoriteParams = new MoveFavoriteParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateFavoriteFolderParams$Type extends MessageType<CreateFavoriteFolderParams> {
    constructor() {
        super("news.CreateFavoriteFolderParams", [
            { no: 1, name: "account_uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "icon", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<CreateFavoriteFolderParams>): CreateFavoriteFolderParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.accountUuid = new Uint8Array(0);
        message.title = "";
        message.icon = 0;
        if (value !== undefined)
            reflectionMergePartial<CreateFavoriteFolderParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateFavoriteFolderParams): CreateFavoriteFolderParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: CreateFavoriteFolderParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes account_uuid = 1; */
        if (message.accountUuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.accountUuid);
        /* string title = 2; */
...
/**
 * @generated MessageType for protobuf message news.CreateFavoriteFolderParams
 */
export const CreateFavoriteFolderParams = new CreateFavoriteFolderParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
class UpdateFavoriteFolderParams$Type extends MessageType<UpdateFavoriteFolderParams> {
    constructor() {
        super("news.UpdateFavoriteFolderParams", [
            { no: 1, name: "uuid", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "title", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "icon", kind: "scalar", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
    create(value?: PartialMessage<UpdateFavoriteFolderParams>): UpdateFavoriteFolderParams {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.uuid = new Uint8Array(0);
        message.title = "";
        message.icon = 0;
        if (value !== undefined)
            reflectionMergePartial<UpdateFavoriteFolderParams>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpdateFavoriteFolderParams): UpdateFavoriteFolderParams {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: UpdateFavoriteFolderParams, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes uuid = 1; */
        if (message.uuid.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.uuid);
        /* string title = 2; */
...
/**
 * @generated MessageType for protobuf message news.UpdateFavoriteFolderParams
 */
export const UpdateFavoriteFolderParams = new UpdateFavoriteFolderParams$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const News = new ServiceType("news.News", [
    { name: "GetFavorites", options: {}, I: GetFavoritesParams, O: GetFavoritesResponse },
    { name: "HasFavorites", options: {}, I: HasFavoritesParams, O: HasFavoritesResponse },
    { name: "ToggleFavorite", options: {}, I: ToggleFavoriteParams, O: Empty },
    { name: "MoveFavorite", options: {}, I: MoveFavoriteParams, O: Empty },
    { name: "CreateFavoriteFolder", options: {}, I: CreateFavoriteFolderParams, O: FavoriteFolder },
    { name: "UpdateFavoriteFolder", options: {}, I: UpdateFavoriteFolderParams, O: FavoriteFolder },
