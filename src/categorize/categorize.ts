...
/**
 * @generated from protobuf message categorize.Article
 */
...
/**
 * @generated from protobuf message categorize.UpsertArticleResponse
 */
...
/**
 * @generated from protobuf message categorize.UpsertArticlesResponse
 */
...
/**
 * @generated from protobuf message categorize.UpsertArticlesRequest
 */
export interface UpsertArticlesRequest {
    /**
     * @generated from protobuf field: repeated categorize.Article articles = 1;
     */
    articles: Article[];
}
/**
 * @generated from protobuf enum categorize.Method
 */
export enum Method {
    /**
...
/**
 * @generated MessageType for protobuf message categorize.UpsertArticleResponse
 */
...
class UpsertArticlesResponse$Type extends MessageType<UpsertArticlesResponse> {
    constructor() {
        super("categorize.UpsertArticlesResponse", [
...
/**
 * @generated MessageType for protobuf message categorize.UpsertArticlesResponse
 */
...
class UpsertArticlesRequest$Type extends MessageType<UpsertArticlesRequest> {
    constructor() {
        super("categorize.UpsertArticlesRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: UpsertArticlesRequest): UpsertArticlesRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated categorize.Article articles */ 1:
    ...
    internalBinaryWrite(message: UpsertArticlesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated categorize.Article articles = 1; */
...
/**
 * @generated MessageType for protobuf message categorize.UpsertArticlesRequest
 */
export const UpsertArticlesRequest = new UpsertArticlesRequest$Type();
/**
 * @generated ServiceType for protobuf service categorize.Categorize
 */
export const Categorize = new ServiceType("categorize.Categorize", [
    { name: "UpsertArticle", options: {}, I: Article, O: Empty },
    { name: "UpsertArticles", options: {}, I: UpsertArticlesRequest, O: Empty }
]);
